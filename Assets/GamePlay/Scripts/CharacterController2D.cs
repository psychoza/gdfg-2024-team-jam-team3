...
/// <summary>
/// Character Controller copy pasta'd from Brackeys with no alteration other than this comment blob.
...
public class CharacterController2D : MonoBehaviour
{
  ...
  private void ManageCoyoteTime(bool wasGrounded, float fixedDeltaTime)
  {
    ...
    {
      m_CoyoteTimeCounter -= fixedDeltaTime;
    }
  }
}